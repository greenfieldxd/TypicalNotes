package com.example.typicalnotes.create_and_update_note.presentation.navigation
...
import com.example.typicalnotes.create_and_update_note.presentation.CreateAndUpdateNoteRoute
...
fun NavController.navigateToCreateAndUpdateNote(
    ...
    val topBarTitleResId = when(topBarTitleResArg) {
        ...
        CreateAndUpdateNoteResArg.UPDATE_NOTE -> context.getString(R.string.update_note_topbar_title)
    }
    navigate(
